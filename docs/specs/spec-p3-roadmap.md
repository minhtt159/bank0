...
>
> **Planning only.** Nothing here is built, and nothing here is a commitment.
> Anything already built is described in the reference docs
> ([`../06-client-api.md`](../06-client-api.md),
> [`../05-admin-ui.md`](../05-admin-ui.md)) and in `db/migrations/`, never here.
> Tracked work lives in the [issue tracker](https://github.com/minhtt159/bank0/issues) - this document is the thinking
> behind the domains, not the queue.
>
