...
func TestJWTRoundTrip(t *testing.T) {
	...
	tok, exp, err := s.issueJWT(uid, "customer", "alice")
	if err != nil {
...
func TestJWTRejectsTamperedSecret(t *testing.T) {
	tok, _, _ := jwtServer("secretA", time.Hour).issueJWT(uuid.New(), "customer", "a")
...
func TestJWTRejectsExpired(t *testing.T) {
	...
	tok, _, _ := s.issueJWT(uuid.New(), "customer", "a")
...
func TestJWTRejectsWrongAudience(t *testing.T) {
	tok, _, _ := jwtServer("topsecret", time.Hour).issueJWT(uuid.New(), "customer", "a")
